...
std::vector<const char *> OMP_v_coll = {"todo"};
// TODO: may be more complicated.. Have a look at Polly (it supports OpenMP)

std::vector<const char *> v_coll(MPI_v_coll.size() + UPC_v_coll.size());
// TODO: add OMP_v_coll
